...
$cek = mysqli_query($db, "SELECT * FROM pengunjung WHERE ip_address='$ip' AND tanggal='$tanggal'");
if (mysqli_num_rows($cek) == 0) {
  mysqli_query($db, "INSERT INTO pengunjung (ip_address, tanggal) VALUES ('$ip', '$tanggal')");
}

$totalPengunjung = mysqli_query($db, "SELECT COUNT(*) AS total FROM pengunjung");
$dataPengunjung = mysqli_fetch_assoc($totalPengunjung);
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Dashboard | Iqbal Rizki Maulana</title>
